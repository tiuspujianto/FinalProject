 ...
 */
package edu.monash.fit.eduard.utils;

import edu.monash.fit.eduard.ui.ErrorDialog;
import java.io.*;
import java.awt.*;
import java.nio.*;
...
public class FileUtils {
     ...
     * @param filter file filter used on Windows by the file chooser to filter
     * out files from the user's view.
