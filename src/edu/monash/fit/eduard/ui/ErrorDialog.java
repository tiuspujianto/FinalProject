 ...
 */
package edu.monash.fit.eduard.ui;
...
public class ErrorDialog {
    ...
    public static void showErrorDialog(final String msg,
        ...
        try {
            // log error before a modal dialog is blocking this thread
            if (e != null) {
                Logger.getLogger(ErrorDialog.class.getName()).log(Level.SEVERE, e.getMessage(), e);
            }
